...
with open('mejoresrecompensas.txt', 'r') as file:
    recompesasideales = [float(line.strip()) for line in file]
mayorrecompensa=2146.0
Best_gen = loaded_Best_gen.copy()
mejorcerebro=6
pesosideales=Best_gen[6]
mejoresrecompensas=recompesasideales
print(recompesasideales)
gen=0
while gen<=50:
...
with open('mejoresrecompensas.txt', 'w') as file:
    for recompensa in mejoresrecompensas:
        file.write(str(recompensa) + '\n')
